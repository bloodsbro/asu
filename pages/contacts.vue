<template>
  <div class="contacts">
    ...
    <div class="contacts__header">
      <img class="contacts__header-logo" src="@/assets/images/contacts/logo.png" alt="" />
    </div>
...
.contacts {
  &__header {
    ...
    background: url('~/assets/images/contacts/background.png');
